...
import it.nicolabrogelli.imedici.adapters.AdapterCharacters;
...
public class ActivityCharacters extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String TAG = ActivityCharacters.class.getSimpleName();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        itemCategory = new AHBottomNavigationItem("Categorie", R.mipmap.ic_list_white_24dp, Color.parseColor("#FF009788"));
        ...
        bottomNavigation.setOnTabSelectedListener(new AHBottomNavigation.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position, boolean wasSelected) {
                ...
                switch (position) {
                    ...
                    case 1:
                        i = new Intent(ActivityCharacters.this, ActivityItineraries.class);
                        startActivity(i);
                        overridePendingTransition(R.anim.open_next, R.anim.close_main);
                        break;

                    case 2:
                        i = new Intent(ActivityCharacters.this, ActivityHome.class);
                        startActivity(i);
                        overridePendingTransition(R.anim.open_next, R.anim.close_main);
                        break;
        ...
        // Set adapter object
        mAdapter = new AdapterCharacters(this);
        ...
        mAdapter.setOnTapListener(new OnTapListener() {
            ...
            public void onTapView(int position) {
                ...
                detailIntent.putExtra(Utils.ARG_ACTIVITY, Utils.TAG_ACTIVITY_CHARRACTERS);
...
//        Intent detailIntent = new Intent(this, ActivityDetail.class);
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    status.startResolutionForResult(ActivityCharacters.this, REQUEST_CHECK_SETTINGS);
    ...
    */
    ...
    public void getCategoryFromDatabase() {
        ArrayList<ArrayList<Object>> dataCategory = mDBHelper.getAllCharactersData();

        // Ad "All Places" in first row
        mCategoryIds.add("0");
        mCategoryNames.add(getString(R.string.all_characters));
    ...
    private void getLocationDataFromDatabase() {
        ...
        ArrayList<Locations> dataLocation = mDBHelper.getObjectLocationsByCharacters(mSelectedCategoryId);
